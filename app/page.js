                ...
                {selectedNote && (
                  <>
                    ...
                    <div style={{ padding: '0.35rem 0.75rem', borderBottom: '1px solid ' + (theme === 'dark' ? '#2a2825' : '#f0ece0'), display: 'flex', gap: '0.35rem', alignItems: 'center', background: theme === 'dark' ? '#161616' : '#faf8f4' }}>
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const e = ta.selectionEnd; const t = noteEditContent; const sel = t.substring(s, e); setNoteEditContent(t.substring(0, s) + '**' + (sel || 'text') + '**' + t.substring(e)) }} title="Bold" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.55rem', cursor: 'pointer', fontSize: '0.78rem', fontWeight: '700', color: theme === 'dark' ? '#d4cfc6' : '#3a3530', lineHeight: 1 }}>B</button>
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const e = ta.selectionEnd; const t = noteEditContent; const sel = t.substring(s, e); setNoteEditContent(t.substring(0, s) + '_' + (sel || 'text') + '_' + t.substring(e)) }} title="Italic" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.65rem', cursor: 'pointer', fontSize: '0.78rem', fontStyle: 'italic', color: theme === 'dark' ? '#d4cfc6' : '#3a3530', lineHeight: 1 }}>I</button>
                      <div style={{ width: '1px', height: '18px', background: theme === 'dark' ? '#333' : '#e0d8cc', margin: '0 0.15rem' }}></div>
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const t = noteEditContent; const ls = t.lastIndexOf('\n', s - 1) + 1; setNoteEditContent(t.substring(0, ls) + '## ' + t.substring(ls)) }} title="Heading" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.45rem', cursor: 'pointer', fontSize: '0.72rem', fontWeight: '700', color: theme === 'dark' ? '#d4cfc6' : '#3a3530', lineHeight: 1 }}>H</button>
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const t = noteEditContent; const ls = t.lastIndexOf('\n', s - 1) + 1; setNoteEditContent(t.substring(0, ls) + '\u2022 ' + t.substring(ls)) }} title="Bullet list" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.45rem', cursor: 'pointer', fontSize: '0.85rem', color: theme === 'dark' ? '#d4cfc6' : '#3a3530', lineHeight: 1 }}>
                      ...
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const t = noteEditContent; const ls = t.lastIndexOf('\n', s - 1) + 1; setNoteEditContent(t.substring(0, ls) + '\u2610 ' + t.substring(ls)) }} title="Checkbox" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.45rem', cursor: 'pointer', fontSize: '0.85rem', color: theme === 'dark' ? '#d4cfc6' : '#3a3530', lineHeight: 1 }}>
                      ...
                      <div style={{ width: '1px', height: '18px', background: theme === 'dark' ? '#333' : '#e0d8cc', margin: '0 0.15rem' }}></div>
                      <button onClick={() => { const ta = document.getElementById('note-editor'); if (!ta) return; const s = ta.selectionStart; const t = noteEditContent; const ls = t.lastIndexOf('\n', s - 1) + 1; setNoteEditContent(t.substring(0, ls) + '\u2014\u2014\u2014\n' + t.substring(ls)) }} title="Divider" style={{ background: 'none', border: '1px solid ' + (theme === 'dark' ? '#333' : '#e0d8cc'), borderRadius: '6px', padding: '0.3rem 0.45rem', cursor: 'pointer', fontSize: '0.72rem', color: theme === 'dark' ? '#d4cfc6' : '#8a8070', lineHeight: 1 }}>—</button>
                    </div>
